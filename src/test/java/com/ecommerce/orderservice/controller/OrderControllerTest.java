...
class OrderControllerTest {
    ...
    void createsOrder() throws Exception {
        ...
        when(orderService.createOrder(any()))
                .thenReturn(sampleResponse(OrderStatus.CREATED));
    ...
    void getOrderNotFound() throws Exception {
        ...
        when(orderService.getOrder(ORDER_ID))
                .thenThrow(
                        ResourceNotFoundException.order(ORDER_ID)
                );
    ...
    void getsHistory() throws Exception {
        ...
        when(orderService.getOrderHistory(USER_ID))
                .thenReturn(
                        List.of(
                                sampleResponse(OrderStatus.CREATED)
                        )
                );
    ...
    void getsStatus() throws Exception {
        ...
        when(orderService.getStatus(ORDER_ID))
                .thenReturn(
    ...
    void cancelConflict() throws Exception {
        ...
        when(orderService.cancelOrder(ORDER_ID))
                .thenThrow(
                        ConflictException.notCancellable(
                                ORDER_ID,
                                OrderStatus.CANCELLED
                        )
                );
